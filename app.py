...
class AudioWorker(QtCore.QThread):
    ...
    def _find_devices(self):
        ...
        self.log.emit(f"Loopback: {self._in_dev['name']}  →  Salida: {self._out_dev['name']}")
    ...
    def run(self):
        ...
        channels_in  = min(self._in_dev["max_input_channels"], 2)
