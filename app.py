...
class AudioWorker(threading.Thread):
    def __init__(self, *, out_name, mix_mic_name, sr, block, mono, sys_gain, mic_gain, limiter):
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QtGui.QIcon("assets/app.ico") if Path("assets/app.ico").exists() else self.style().standardIcon(QtWidgets.QStyle.SP_MediaPlay))
        ...
        self.block_spin.setRange(120, 4096)
        self.block_spin.setValue(960)

        self.mono_chk = QtWidgets.QCheckBox("Forzar mono")
        self.limiter_chk = QtWidgets.QCheckBox("Limitador")

        self.sys_gain_d = QtWidgets.QDoubleSpinBox()
        self.sys_gain_d.setRange(0.0, 5.0); self.sys_gain_d.setSingleStep(0.1); self.sys_gain_d.setValue(1.0)
        self.mic_gain_d = QtWidgets.QDoubleSpinBox()
        self.mic_gain_d.setRange(0.0, 5.0); self.mic_gain_d.setSingleStep(0.1); self.mic_gain_d.setValue(1.0)
        ...
        h2.addWidget(self.mono_chk)
        h2.addWidget(self.limiter_chk)
        h2.addStretch()
        ...
        h3.addStretch()
        h3.addWidget(self.open_logs_btn)
    ...
    def _init_tray(self):
        ...
        self.action_toggle = menu.addAction("Iniciar")  # cambia a "Detener" si corre
